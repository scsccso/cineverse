...
└── frontend/                 # Next.js frontend
    ...
    └── src/
        ...
        │   └── admin/         # Admin backend (independent nav shell + role check): /admin/dashboard, /admin/movies(/new, /[id]/edit), /admin/cinemas(/[id]), /admin/showtimes(/new), /admin/bookings(/[id]), /admin/tickets/redeem, /admin/users
